...
@RestAssuredTest
class LargerFilesAPIV2Test {

    private final FileFormFactory fileFormFactory;

    public LargerFilesAPIV2Test(final FileFormFactory fileFormFactory) {
    ...
    void shouldWhenPostInRightReturnStatusCreatedWithLocation() {
        RestAssured
                ...
                .log().all()
                .when()
                .body(fileFormFactory.createFileApiV1Four())
    ...
    @Test
    @Order(3)
    void shouldReturnStatusOKAndMessageLagerFiles() {
        RestAssured
                .given()
                .log().all()
                .when()
                ...
                .body(containsString("Documentos<test> são de tamanhos diferentes"));
    }
}
